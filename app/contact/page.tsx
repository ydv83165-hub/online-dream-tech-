    ...
    <>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div style={{ borderColor: "#D4AF37" }} className="rounded-[1.75rem] border border-slate-200 bg-slate-900 p-6 sm:p-8 text-white shadow-[0_24px_45px_rgba(15,23,42,0.14)]">
              ...
              <p className="mt-6 text-xs text-slate-400">
                Prefer a quick call? Reach us at <Link href="tel:+919936860125" className="text-white underline underline-offset-2">+91 9936860125</Link>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#ffffff] px-0 py-0">
        <div className="w-full">
          <div className="relative overflow-hidden rounded-none border-y border-[#D4AF37] bg-[#0a1b2e] shadow-[0_22px_55px_rgba(7,20,38,0.35)]">
